...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'aviation.db'),
    },
    'airports': {
        'ENGINE': 'django.db.backends.sqlite3',
        # 'NAME': '/put/path/to/airports.db',
        'NAME': '/Users/jstrick/curr/courses/python/DATA/airports.db'
    },

}

DATABASE_ROUTERS = [
    'aviation.dbrouters.AirportsRouter',
]
