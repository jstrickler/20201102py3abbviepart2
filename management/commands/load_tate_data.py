...
class Command(BaseCommand):
    help = (
    """Loads Tate Gallery data from CSV files   into models. 
    """
    )

    def add_arguments(self, parser):
        parser.add_argument('data_folder', type=str, help="Path to folder containing artist_data.csv and artwork_data.csv")
