...
class Presidents(models.Model):
    termnum = models.IntegerField(blank=True, null=True)
    ...
    birthplace = models.CharField(max_length=80, blank=True, null=True)
    birthstate = models.CharField(max_length=80, blank=True, null=True)
